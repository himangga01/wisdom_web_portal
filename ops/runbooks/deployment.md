...
3. 이제 `ops/scripts/preflight.mjs`로 verified `public-current`, `arm64`, Node 24, Caddy, cloudflared, age, `better-sqlite3`, SQLite 버전과 쓰기 가능한 경로를 확인한다. 이 gate를 통과하기 전에는 tunnel을 시작하지 않는다.

...
- The shared extraction contains only the pre-existing ownership-verification contract plus the required single-line hardening; origin parsing was not moved or generalized.

...
5. [`docs/operations/remaining-work-handoff.md`](operations/remaining-work-handoff.md): 다음 작업자가 이어서 구현할 우선순위, 중단 조건, 운영자 준비값과 검증 명령
...
| 구현 재개·작업 인수인계 | [`docs/operations/remaining-work-handoff.md`](operations/remaining-work-handoff.md) | 현재 Git 기준점, 남은 코드 차단 항목, 보안 중단 조건, 운영자 준비값과 권장 실행 순서 |
